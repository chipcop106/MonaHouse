                        ...
                        {!!RoomGoInState.dataForm[0].services &&
                            RoomGoInState.dataForm[0].services.length > 0 && (
                                <View style={[styles.formRow, styles.rowInfo]}>
                                    ...
                                    <Text style={styles.rowValue}>
                                        {cf(
                                            RoomGoInState.dataForm[0].services.reduce(
                                                (prev, cur) => {
                                                    return (
                                                        prev +
                                                        parseInt(
                    ...
                    <View style={[styles.formWrap]}>
                        <View style={[styles.formRow, styles.fullWidth]}>
                            <Select
                                ...
                                value={
                                    depositType[
                                        stateCheckout.depositTypeIndex.row
                                    ] || "Chọn loại cọc"
                                }
                        ...
                        <View style={[styles.formRow, styles.fullWidth]}>
                            <Select
                                ...
                                value={
                                    preDepositTime[
                                        stateCheckout.preDepositTimeIndex.row
                                    ] || "Thời gian trả trước"
                                }
                                selectedIndex={
                                    stateCheckout.preDepositTimeIndex
                                }
                    ...
                    <View style={[styles.formWrap]}>
                        <View style={[styles.formRow, styles.fullWidth]}>
                            <Select
                                ...
                                value={
                                    prePaymentTime[
                                        stateCheckout.prePaymentTimeIndex.row
                                    ] || "Trả trước tới"
                                }
                                selectedIndex={
                                    stateCheckout.prePaymentTimeIndex
                                }
                    ...
                    <View style={styles.formWrap}>
                        ...
                        <View style={[styles.formRow, styles.fullWidth]}>
                            <Select
                                ...
                                value={
                                    paymentType[
                                        stateCheckout.paymentTypeIndex.row
