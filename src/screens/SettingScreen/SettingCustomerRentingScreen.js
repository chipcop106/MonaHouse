...
import { getCustomerRenting } from "~api/RenterAPI";
          ...
          <View style={styles.topLeft}>
            ...
            <View style={styles.info}>
              ...
              >
                ...
                >
                  <Text style={{ color: color.labelColor }}>Dư nợ:</Text>
                  <Text
                    style={{
                      ...styles.value,
                      color: item.Debt < 0 ? color.redColor : color.greenColor,
                    }}
                  >
...
const SettingCustomerRentingScreen = () => {
  const {
    state,
    setQuerySearch,
...
export default SettingCustomerRentingScreen;
