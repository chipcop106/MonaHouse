...
import {
    Input, Select, SelectItem, Icon, Text, Divider, IndexPath, Button
...
const MoneyCollectScreen = () => {
    ...
    return (
        <>
            <ScrollView>
                {userInfo ? (<UserInfo avatar={userInfo.Avatar} name={userInfo.FullName} phone={userInfo.Phone} />) : <Text>Loading...</Text>}
                <View style={styles.mainWrap}>
                    <View style={styles.section}>
                        <Text category="h6" status="primary" style={{ marginBottom: 20 }}>Phòng 02</Text>
                        <View style={[styles.formWrap]}>
                            <View style={[styles.formRow, styles.rowInfo]}>
                                <Text style={styles.rowLabel}>Tiền phòng:</Text>
                                <Text status="basic" style={[styles.rowValue, { fontWeight: '600' }]}>3.000.000</Text>
                            </View>
                            <View style={[styles.formRow, styles.rowInfo]}>
                                <Text style={styles.rowLabel}>Điện tháng trước:</Text>
                                <Text status="basic" style={[styles.rowValue, { fontWeight: '600' }]}>3.000.000</Text>
                            </View>
                            <View style={[styles.formRow, styles.rowInfo]}>
                                <Text style={styles.rowLabel}>Nước tháng trước:</Text>
                                <Text status="basic" style={[styles.rowValue, { fontWeight: '600' }]}>3.000.000</Text>
                            </View>
                            <View style={[styles.formRow, styles.rowInfo]}>
                            ...
                            <View style={[styles.formRow, styles.rowInfo]}>
                                ...
                                <Input
                                    ...
                                    onChangeText={(nextValue) => setActuallyReceived(nextValue)}
                                />
                            </View>
