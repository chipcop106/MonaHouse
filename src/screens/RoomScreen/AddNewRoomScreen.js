        ...
        <View style={styles.section}>
          <View style={styles.formGroup}>
            <Select
              ...
              onSelect={(index) => updateState('motelIndex', index)}>
              {listMotels ? (
                [...listMotels].map((motel) => (
                  <SelectItem key={(item) => item.ID} title={motel.MotelName} />
                ))
              ) : (
          ...
          <View style={styles.formGroup}>
            <Input
              ...
              onChangeText={(newValue) => updateState('roomName', newValue)}
            />
          </View>
          ...
          <View style={styles.formRow}>
            <View style={[styles.formGroup, styles.col]}>
              <Input
                ...
                onChangeText={(newValue) =>
                  updateState('electricPrice', newValue.replace(/\./g, ''))
                }
                style={styles.input}
                textStyle={styles.textInput}
                keyboardType="numeric"
          ...
          <View style={styles.formGroup}>
            <Input
              ...
              onChangeText={(newValue) => updateState('description', newValue)}
              style={styles.input}
              textStyle={styles.textInput}
              multiline={true}
              numberOfLines={3}
